...
function DISPLAY_ULTIMATE_SOCIAL_ICONS($args = null, $content = null)
{
    ...
    if (empty($option9['sfsi_show_via_shortcode']) || $option9['sfsi_show_via_shortcode'] === 'no') {
        return false;
    }
...
function addStyleFunction()
{
    ...
    <style type="text/css" aria-selected="true">
        ...
        <?php else: ?><?php if (isset($option8['sfsi_form_width']) && $option8['sfsi_form_width']):?> width: <?php echo intval($option8['sfsi_form_width']) . 'px !important;' ?> <?php endif;?> <?php if (isset($option8['sfsi_form_height']) && $option8['sfsi_form_height'] ): ?> height:<?php echo intval($option8['sfsi_form_height']) . 'px !important;' ?><?php endif;?><?php endif;
    }
 if (isset($option8['sfsi_form_border'])){
             if (sanitize_text_field($option8['sfsi_form_border'])=='yes'): ?> border: <?php echo intval($option8['sfsi_form_border_thickness']) . "px solid ". sfsi_sanitize_hex_color($option8['sfsi_form_border_color']);
    ?> !important;
    ...
    ?> padding: 18px 0px !important;
        ...
        .sfsi_subscribe_Popinner h5 {
            ...
            <?php
                ...
                ?> font-weight: <?php echo sanitize_text_field($option8['sfsi_form_heading_fontstyle']) . ' !important;' ?> <?php
    }
}?> <?php if (isset($option8['sfsi_form_heading_fontcolor']) && $option8['sfsi_form_heading_fontcolor']): ?> color:<?php echo sfsi_sanitize_hex_color($option8['sfsi_form_heading_fontcolor']) . ' !important;' ?><?php endif; ?><?php if (isset($option8['sfsi_form_heading_fontsize']) && $option8['sfsi_form_heading_fontsize']):?> font-size: <?php echo intval($option8['sfsi_form_heading_fontsize']) . "px !important;"?> <?php endif;?> <?php if (isset($option8['sfsi_form_heading_fontalign']) && $option8['sfsi_form_heading_fontalign']):?> text-align:<?php echo sanitize_text_field($option8['sfsi_form_heading_fontalign']) . ' !important;' ?><?php endif;?> margin: 0 0 10px !important;
            padding: 0 !important;
        }
        ...
        <?php if (isset($option8['sfsi_form_field_font']) && $option8['sfsi_form_field_font']):?> font-family: <?php echo sanitize_text_field($option8['sfsi_form_field_font']) . ' !important;';?> <?php endif;?> <?php
     if (isset($option8['sfsi_form_field_fontstyle'])){
              if (sanitize_text_field($option8['sfsi_form_field_fontstyle']) !='bold') {
        ?> font-style:<?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) .' !important;' ?> <?php
              }else {
        ?> font-weight: <?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) ?> !important;
        <?php
                  }
         }
    ?><?php if (isset($option8['sfsi_form_field_fontcolor']) && $option8['sfsi_form_field_fontcolor']):?> color: <?php echo sfsi_sanitize_hex_color($option8['sfsi_form_field_fontcolor']) . ' !important;';?> <?php endif;?> <?php if (isset($option8['sfsi_form_field_fontsize']) && $option8['sfsi_form_field_fontsize']):?> font-size:<?php echo intval($option8['sfsi_form_field_fontsize']) . "px !important;";?><?php endif;?><?php if (isset($option8['sfsi_form_field_fontalign']) && $option8['sfsi_form_field_fontalign']):?> text-align: <?php echo sanitize_text_field($option8['sfsi_form_field_fontalign']) . ' !important;';?><?php endif?>
        }
    ...
    if (isset($option8['sfsi_form_field_fontstyle'])){
            if (sanitize_text_field($option8['sfsi_form_field_fontstyle']) !='bold') {
        ?> font-style:<?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) . ' !important;' ?><?php }else {?> font-weight: <?php echo  sanitize_text_field($option8['sfsi_form_field_fontstyle']) . ' !important;' ?> <?php
            }
    }
?> <?php if (isset($option8['sfsi_form_field_fontcolor']) && $option8['sfsi_form_field_fontcolor']):?> color:<?php echo sfsi_sanitize_hex_color($option8['sfsi_form_field_fontcolor']) . ' !important;';?><?php endif?><?php if (isset($option8['sfsi_form_field_fontsize']) && $option8['sfsi_form_field_fontsize']): ?> font-size: <?php echo intval($option8['sfsi_form_field_fontsize']) . "px !important;"?> <?php endif;?> <?php if (isset($option8['sfsi_form_field_fontalign']) && $option8['sfsi_form_field_fontalign'] ):?> text-align:<?php echo sanitize_text_field($option8['sfsi_form_field_fontalign']) . ' !important;';?><?php endif;?>
        }
        ...
        .sfsi_subscribe_Popinner input[type=email]:-moz-placeholder {
            /* Firefox 18- */
        <?php if (isset($option8['sfsi_form_field_font']) && $option8['sfsi_form_field_font']):?> font-family: <?php echo sanitize_text_field($option8['sfsi_form_field_font']) . ' !important;';?> <?php endif;?> <?php if (isset($option8['sfsi_form_field_fontstyle']) && $option8['sfsi_form_field_fontstyle']){
              if (sanitize_text_field($option8['sfsi_form_field_fontstyle']) !='bold') {
        ?> font-style:<?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) . ' !important;' ?> <?php
              }else{
     ...
     if (isset($option8['sfsi_form_field_fontstyle']) && $option8['sfsi_form_field_fontstyle']){
         if (sanitize_text_field($option8['sfsi_form_field_fontstyle']) !='bold') {?> font-style: <?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) ?> !important;
            <?php
                      }else {
                ?> font-weight: <?php echo sanitize_text_field($option8['sfsi_form_field_fontstyle']) . ' !important;' ?> <?php
              }
        ...
        .sfsi_subscribe_Popinner input[type=email]:-ms-input-placeholder {
            ...
            font-family: <?php echo isset($option8['sfsi_form_field_font']) ? sanitize_text_field($option8['sfsi_form_field_font']) . ' !important;' : '';?> <?php if (sanitize_text_field($option8['sfsi_form_field_fontstyle']) !='bold') {
        ?> font-style:<?php echo isset($option8['sfsi_form_field_fontstyle']) ? sanitize_text_field($option8['sfsi_form_field_fontstyle']) . ' !important;' : '' ?> <?php
    }
    ...
    endif;?> <?php if ($option8['sfsi_form_field_fontsize']):?> font-size:<?php echo intval($option8['sfsi_form_field_fontsize']) . "px !important"?>;
        <?php endif;?><?php if ($option8['sfsi_form_field_fontalign']):?> text-align: <?php echo sanitize_text_field($option8['sfsi_form_field_fontalign']) . ' !important;';?><?php endif;?>
        }

        .sfsi_subscribe_Popinner input[type=submit] {

        <?php if (isset($option8['sfsi_form_button_font']) && $option8['sfsi_form_button_font']):?> font-family: <?php echo sanitize_text_field($option8['sfsi_form_button_font']) . ' !important;'; ?> <?php endif;?> <?php
    if (isset($option8['sfsi_form_button_fontstyle'])){
        ...
        ?> font-style: <?php echo sanitize_text_field($option8['sfsi_form_button_fontstyle']) ?> !important;
            ...
            ?> font-weight: <?php echo isset($option8['sfsi_form_button_fontstyle']) ? sanitize_text_field($option8['sfsi_form_button_fontstyle']) . ' !important;' : '' ?> <?php
           }
    }
?> <?php if (isset($option8['sfsi_form_button_fontcolor']) && $option8['sfsi_form_button_fontcolor']):?> color:<?php echo sfsi_sanitize_hex_color($option8['sfsi_form_button_fontcolor']) . ' !important;'; ?><?php endif;?><?php if (isset($option8['sfsi_form_button_fontsize']) && $option8['sfsi_form_button_fontsize']):?> font-size: <?php echo intval($option8['sfsi_form_button_fontsize']) . "px !important;"?> <?php endif;?> <?php if (isset($option8['sfsi_form_button_fontalign']) && $option8['sfsi_form_button_fontalign']):?> text-align:<?php echo sanitize_text_field($option8['sfsi_form_button_fontalign']) . ' !important;';?><?php endif;?><?php if (isset($option8['sfsi_form_button_background']) && $option8['sfsi_form_button_background']):?> background-color: <?php echo sfsi_sanitize_hex_color($option8['sfsi_form_button_background']) . ' !important;';?><?php endif?>
        }
...
function sfsi_error_reporting_notice()
{
    if (is_admin()) :
        ...
        if (isset($isDismissed) && false == $isDismissed && defined('WP_DEBUG') && false != WP_DEBUG && "yes" == $sfsi_icons_suppress_errors) { ?>
            ...
            <div style="padding: 10px;margin-left: 0px;position: relative;" id="sfsi_error_reporting_notice"
                 class="error notice">
